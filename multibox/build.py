...
def add_detection_heads(graph, inputs, num_bboxes_per_cell, batch_size, cfg):
  ...
  with graph.name_scope("detection"):
    ...
    with graph.name_scope("8x8"):
      ...
      detect_8_locations = v3.add_conv(
        graph = graph,
      ...
      detect_8_confidences = v3.add_conv(
        graph = graph,
        input = detect_8_conv_1,
    ...
    with graph.name_scope("6x6"):
      ...
      detect_6_locations = v3.add_conv(
        graph = graph,
      ...
      detect_6_confidences = v3.add_conv(
        graph = graph,
        input = detect_6_conv_1,
        shape = [1, 1, 96, num_bboxes_per_cell],
        strides = [1, 1, 1, 1],
    ...
    with graph.name_scope("4x4"):
      ...
      detect_4_locations = v3.add_conv(
        graph = graph,
        input = detect_4_conv,
      ...
      detect_4_confidences = v3.add_conv(
        graph = graph,
        input = detect_4_conv,
    ...
    with graph.name_scope("3x3"):
      ...
      detect_3_locations = v3.add_conv(
        graph = graph,
      ...
      detect_3_confidences = v3.add_conv(
        graph = graph,
        input = detect_3_conv_1,
        shape = [1, 1, 96, num_bboxes_per_cell],
        strides = [1, 1, 1, 1],
    ...
    with graph.name_scope("2x2"):
      ...
      detect_2_locations = v3.add_conv(
        graph = graph,
      ...
      detect_2_confidences = v3.add_conv(
        graph = graph,
        input = detect_2_conv_1,
        shape = [1, 1, 96, num_bboxes_per_cell],
        strides = [1, 1, 1, 1],
    ...
    with graph.name_scope("1x1"):
      ...
      detect_1_locations = v3.add_conv(
        graph = graph,
        input = detect_1_pool,
        shape = [1, 1, 2048, 4],
        strides = [1, 1, 1, 1],
      ...
      detect_1_confidences = v3.add_conv(
        graph = graph,
        input = detect_1_pool,
        shape = [1, 1, 2048, 1],
        strides = [1, 1, 1, 1],
